...
public:
    ...
    static constexpr int kOffmeshControlCount = 1;
    ...
    bool FetchOffmeshControl(OffmeshControlSlot& outSlot) const;
    bool WriteOffmeshControl(const OffmeshControlSlot& slot) const;
...
private:
    ...
    uintptr_t offmeshControlBufferAddress = 0;
