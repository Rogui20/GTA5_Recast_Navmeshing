...
public:
    ...
    bool GenerateAutomaticOffmeshLinksForTileV2(int tx,
                                                ...
                                                const std::vector<std::pair<glm::vec3, glm::vec3>>* dirtyOffmeshBounds = nullptr,
                                                size_t* outEdgesSkippedOutsideDirtyBounds = nullptr,
                                                size_t* outEdgesTestedInsideDirtyBounds = nullptr,
